    ...
    public partial class MainMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProdutosNotaFiscal", x => new { x.NotaFiscalId, x.ProdutoId });
                    table.ForeignKey(
                        name: "FK_ProdutosNotaFiscal_NotasFiscais_NotaFiscalId",
                        column: x => x.NotaFiscalId,
                        principalTable: "NotasFiscais",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProdutosNotaFiscal_Produtos_ProdutoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProdutosNotaFiscal_ProdutoId",
