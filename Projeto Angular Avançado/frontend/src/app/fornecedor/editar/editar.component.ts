...
export class EditarComponent extends FornecedorBaseComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder, private fornecedorService: FornecedorService, private router: Router,
        private toastr: ToastrService, private route: ActivatedRoute, private modalService: NgbModal, private spinner: NgxSpinnerService)
    {
        super();
    ...
    ngAfterViewInit(): void {
        this.getFormField('tipoFornecedor').valueChanges.subscribe(() => {
