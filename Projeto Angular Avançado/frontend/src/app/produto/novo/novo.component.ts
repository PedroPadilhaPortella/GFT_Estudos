...
export class NovoComponent extends ProdutoBaseComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder, private produtoService: ProdutoService, private router: Router, private toastr: ToastrService) {
        super();
    }
    ...
    adicionarProduto() {
        if (this.produtoForm.dirty && this.produtoForm.valid) {
            ...
            this.produto.imagemUpload = this.croppedImage.split(',')[1]; //retirando o cabeçalho da imagem
            this.produto.imagem = this.imageName; //nome da imagem
