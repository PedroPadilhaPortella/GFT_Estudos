...
namespace Store.Tests.Handlers
{
    ...
    public class OrderHandlerTests
    {
        ...
        [TestMethod]
        [TestCategory("Handlers")]
        public void Dado_uma_promocao_invalida_o_pedido_deve_ser_gerado_independente()
        {
            var command = new CreateOrderCommand();
            command.Customer = "Pedro Portella";
            command.ZipCode = "13454424";
        ...
        [TestMethod]
        [TestCategory("Handlers")]
        public void Dado_um_comando_valido_o_pedido_nao_deve_ser_gerado_independente()
        {
            var command = new CreateOrderCommand();
            command.Customer = "Pedro Portella";
            command.ZipCode = "12345678";
