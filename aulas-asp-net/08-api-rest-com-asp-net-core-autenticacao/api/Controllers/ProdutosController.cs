...
namespace api.Controllers
{
    ...
    public class ProdutosController : ControllerBase
    {
        ...
        [HttpGet("claim")] //metodo de uma claim
        public IActionResult Claims(){
            var claimUser = HttpContext.User.Claims.First(claim => claim.Type.ToString().Equals("id", StringComparison.InvariantCultureIgnoreCase)).Value;
            return Ok(claimUser);
        }
